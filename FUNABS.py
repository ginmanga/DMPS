...
BS1DF['MVBook'] = (BS1DF['MVEquity']+BS1DF['TOTALDEBT'] -
...
BS1DF['MLEV'] = BS1DF['TOTALDEBT']/(BS1DF['TOTALDEBT'] + BS1DF['MVEquity']) #tangf
BS1DF['BLEV'] = BS1DF['TOTALDEBT']/BS1DF['at']

list_variables = ['MVEquity','MVBook', 'PROF', 'DIVP','CASH', 'TANG', 'CAPEX', 'ADVERT', 'RD', 'MLEV', 'BLEV']


BS1DF.to_csv(os.path.join(datadirectory_2, "BSprocessed.csv"), index=False)
