...
COMPUCRSPIQ_small = pd.read_csv(os.path.join(datadirectory, "MERGEDIDCR-ALLFEB27.csv.gz"))
...
COMPUCRSPIQ_small = Functions.prep_asof(COMPUCRSPIQ_small, 'LPERMNO') # check if can erase
#CRSPM = Functions.prep_asof(CRSPM)
...
FUNDALIST_CRSPIDS.to_csv(os.path.join(datadirectory, "FUNDALIST_CRSPIDSFEB28.csv.gz"), index=False, compression='gzip')